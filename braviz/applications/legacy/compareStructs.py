...
class CompareStructs(object):

    def __init__(self):
        global renWin, renWin2, scheduled_refresh
        # Visualization
        ...
        show_planes = tk.Checkbutton(
            control_frame, text='Show Images', command=imagePlanesStatus, variable=active_planes, pady=10)
        show_planes.grid()
        ...
        select_model = braviz.interaction.structureList(
            reader, ref_subj, changeStruct, control_frame, text='Model', padx=10, pady=15)
