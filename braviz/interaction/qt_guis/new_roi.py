...
class Ui_NewRoi(object):
    def setupUi(self, NewRoi):
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.roi_desc)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.SpanningRole, self.error_msg)
    ...
    def retranslateUi(self, NewRoi):
        NewRoi.setWindowTitle(_translate("NewRoi", "Create New ROI", None))
        self.label.setText(_translate("NewRoi", "Roi Name:", None))
        ...
        self.roi_space.setItemText(3, _translate("NewRoi", "Diff", None))
