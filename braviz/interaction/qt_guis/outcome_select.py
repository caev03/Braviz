...
# Form implementation generated from reading ui file 'E:\braviz\braviz\interaction\qt_guis\outcome_select.ui'
#
...
class Ui_SelectOutcomeDialog(object):
    ...
    def retranslateUi(self, SelectOutcomeDialog):
        ...
        self.label_6.setToolTip(_translate("SelectOutcomeDialog", "Select the optimal value for this value, the value that would be considered \"good\"", None))
        self.label_6.setText(_translate("SelectOutcomeDialog", "Optimum", None))
        self.optimum_real_value.setText(_translate("SelectOutcomeDialog", "0", None))
        self.label_5.setToolTip(_translate("SelectOutcomeDialog", "Select the expected maximum value for this variable", None))
        self.label_5.setText(_translate("SelectOutcomeDialog", "Maximum", None))
        self.optimum_val.setSuffix(_translate("SelectOutcomeDialog", "%", None))
        self.label_4.setToolTip(_translate("SelectOutcomeDialog", "Select the expected minimum value for this variable", None))
        self.label_4.setText(_translate("SelectOutcomeDialog", "Minimum", None))
        self.label_7.setText(_translate("SelectOutcomeDialog", " = ", None))
        self.reset_real_meta.setText(_translate("SelectOutcomeDialog", "Reset Minimum, Maximum and Optimum", None))
