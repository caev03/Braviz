...
# Form implementation generated from reading ui file 'E:\braviz\braviz\interaction\qt_guis\regressors_select.ui'
#
...
class Ui_AddRegressorDialog(object):
    def setupUi(self, AddRegressorDialog):
        AddRegressorDialog.setObjectName(_fromUtf8("AddRegressorDialog"))
        AddRegressorDialog.setWindowModality(QtCore.Qt.ApplicationModal)
        AddRegressorDialog.resize(1052, 462)
        AddRegressorDialog.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        AddRegressorDialog.setSizeGripEnabled(True)
        AddRegressorDialog.setModal(True)
        self.horizontalLayout = QtGui.QHBoxLayout(AddRegressorDialog)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.frame_3 = QtGui.QFrame(AddRegressorDialog)
        ...
        self.current_regressors_table = QtGui.QTableView(self.frame_3)
        self.current_regressors_table.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.current_regressors_table.setAlternatingRowColors(True)
        self.current_regressors_table.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        self.current_regressors_table.setSortingEnabled(True)
        self.current_regressors_table.setObjectName(_fromUtf8("current_regressors_table"))
        self.current_regressors_table.horizontalHeader().setStretchLastSection(True)
        self.verticalLayout_2.addWidget(self.current_regressors_table)
        ...
        self.frame = QtGui.QFrame(AddRegressorDialog)
        ...
        self.plot_frame = QtGui.QFrame(AddRegressorDialog)
        ...
        self.label_3.setBuddy(self.var_description)
        self.label_4.setBuddy(self.minimum_val)
        self.label_5.setBuddy(self.maximum_val)

        self.retranslateUi(AddRegressorDialog)
        self.details_frame.setCurrentIndex(1)
        QtCore.QMetaObject.connectSlotsByName(AddRegressorDialog)

    def retranslateUi(self, AddRegressorDialog):
        AddRegressorDialog.setWindowTitle(_translate("AddRegressorDialog", "Select Regressors", None))
        self.search_box.setPlaceholderText(_translate("AddRegressorDialog", "Search", None))
        self.add_button.setText(_translate("AddRegressorDialog", "Save and Add", None))
        self.label.setText(_translate("AddRegressorDialog", "Current  Regressors", None))
        self.done_button.setText(_translate("AddRegressorDialog", "Done", None))
        self.var_name.setText(_translate("AddRegressorDialog", "Select Regressor Variable", None))
        self.label_2.setText(_translate("AddRegressorDialog", "Type :", None))
        self.var_type_combo.setItemText(0, _translate("AddRegressorDialog", "Real", None))
        self.var_type_combo.setItemText(1, _translate("AddRegressorDialog", "Nominal", None))
        self.label_3.setText(_translate("AddRegressorDialog", "Description :", None))
        self.label_4.setToolTip(_translate("AddRegressorDialog", "Select the expected minimum value for this variable", None))
        self.label_4.setText(_translate("AddRegressorDialog", "Minimum", None))
        self.label_5.setToolTip(_translate("AddRegressorDialog", "Select the expected maximum value for this variable", None))
        self.label_5.setText(_translate("AddRegressorDialog", "Maximum", None))
        self.label_6.setToolTip(_translate("AddRegressorDialog", "Select the optimal value for this value, the value that would be considered \"good\"", None))
        self.label_6.setText(_translate("AddRegressorDialog", "Optimum", None))
        self.optimum_val.setSuffix(_translate("AddRegressorDialog", "%", None))
        self.label_7.setText(_translate("AddRegressorDialog", " = ", None))
        self.optimum_real_value.setText(_translate("AddRegressorDialog", "0", None))
        self.reset_real_meta.setText(_translate("AddRegressorDialog", "Reset Minimum, Maximum and Optimum", None))
        self.save_button.setText(_translate("AddRegressorDialog", "Save", None))
